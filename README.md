...
O projeto está em **desenvolvimento contínuo** — conforme meu aprendizado avança, novas funcionalidades e melhorias serão adicionadas.
...
- Adicionar operações avançadas (%, raiz quadrada, etc.)
...
⭐ *Se este projeto te inspirou de alguma forma, deixa uma estrela no repositório!*
